package javacourse.ocp.concurrency.collections.exercises.priorityqueue.task;

/**
 * This class stores the attributes of an event. Its thread
 * and is priority.
 * 
 * <B>Implements the comparable interface to
 * help the priority queue to decide which event has more priority</b>
 * 
 *
 */
