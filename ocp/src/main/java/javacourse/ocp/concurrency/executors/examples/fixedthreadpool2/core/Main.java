package javacourse.ocp.concurrency.executors.examples.fixedthreadpool2.core;
...
import javacourse.ocp.concurrency.executors.examples.fixedthreadpool2.task.FactorialCalculator;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		for (int i=0; i<resultList.size(); i++) {
			...
			Integer number=null;
			try {
				number=result.get(); //Espera por hasta obtener el resultado...
				/*
				try{ // otra opción....
