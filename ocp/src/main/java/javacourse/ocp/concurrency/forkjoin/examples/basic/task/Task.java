package javacourse.ocp.concurrency.forkjoin.examples.basic.task;
...
public class Task extends RecursiveAction {
	...
	protected void compute() {
		if (last-first<10) {
			...
			invokeAll(t1, t2); // Executes synchronous... The Thread is idle while the task is processing... So it will steal other task	
		}
	}
